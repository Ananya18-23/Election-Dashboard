...
📊 Power BI – Core platform for interactive gauges, pie charts, and tables.

📈 DAX/Power Query – For vote calculations, seat comparisons, and dynamic filtering.

🖼️ Image Integration – Candidate photos and flags for visual engagement.
...
Post-2024 elections, stakeholders need quick insights into BJP's national decline (303→240 seats) despite Madhya Pradesh clean sweeps, and vote share shifts amid rising turnout. Questions like "How did BJP retain Bhopal dominance?" or "What drove INC gains nationally?" remain hard without visuals.

- Goal of the Dashboard
  
Provide an interactive tool to compare 2019-2024 metrics, filter by party/constituency, and uncover trends like BJP's 37-38% vote share stability.
​
- Walkthrough of Key Visuals
 
Top KPIs (Left Panels): BJP seats 303 (2019) → 240 (2024); INC 52 → 99; pie charts for 613M (2019) vs 645M (2024) votes split by BJP/INC/others.
​
